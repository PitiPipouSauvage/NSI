...
Dans le bloc de code suivant est détaillé le fonctionnement de la classe `ABR` :  

```python
arbre = ABR(...) # avec des nombres car sinon les valeurs ne sont pas comparables
arbre.inserer(...)
...
J'essaierai d'ajouter les algorithmes ou structures au fur et à mesure de l'année ...
